...
<body class="bg-slate-50 text-slate-900">
    ...
    <!-- Navigation -->
    <nav class="glass sticky top-8 z-40 mx-4 px-6 py-4 rounded-2xl border border-white/20 shadow-lg flex justify-between items-center">
        ...
        <div class="hidden md:flex gap-8 font-medium">
            ...
            <!-- Link Tiket Dinamis (Ganti ticket.html) -->
            <a href="{{ route('ticket') }}" class="hover:text-indigo-600 transition text-indigo-600 font-bold">Tiket Saya</a>
        </div>
    </nav>
    ...
    <!-- Footer -->
    <footer class="bg-indigo-900 text-indigo-200 py-20 px-6 mt-20">
